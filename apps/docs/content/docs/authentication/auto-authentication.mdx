...
| `retries` | `3` | Automatic retries for failed HTTP requests (network errors, 429, 5xx) — unrelated to 401 handling, which always re-authenticates and retries exactly once regardless of this value |
