---
title: Bytes
description: Human-readable byte conversion helpers — parse, format, and convert data sizes.
---

The `bytes` utilities help you work with Marzban's numeric byte values (e.g. `data_limit`, `used_traffic`) in a human-friendly way.
