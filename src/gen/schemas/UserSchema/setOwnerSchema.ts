...
export type SetOwnerPathParamsSchema = SetOwnerPathParams

export const setOwnerQueryParamsSchema = z.object({
  admin_username: z.string(),
}) as unknown as ToZod<SetOwnerQueryParams>

export type SetOwnerQueryParamsSchema = SetOwnerQueryParams
...
export type SetOwner200Schema = SetOwner200
...
export type SetOwner401Schema = SetOwner401
...
export type SetOwner422Schema = SetOwner422

export const setOwnerMutationResponseSchema = setOwner200Schema as unknown as ToZod<SetOwnerMutationResponse>

export type SetOwnerMutationResponseSchema = SetOwnerMutationResponse
