...
export const AdminApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    activateAllDisabledUsers: async (username: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/admin/{username}/users/activate`.replace(
        `{${'username'}}`,
    ...
    disableAllActiveUsers: async (username: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/admin/{username}/users/disable`.replace(
        `{${'username'}}`,
        encodeURIComponent(String(username))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getAdminUsage: async (username: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/admin/usage/{username}`.replace(
        `{${'username'}}`,
        encodeURIComponent(String(username))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    modifyAdmin: async (
      ...
      const localVarPath = `/api/admin/{username}`.replace(`{${'username'}}`, encodeURIComponent(String(username)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
    ...
    resetAdminUsage: async (username: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/admin/usage/reset/{username}`.replace(
        `{${'username'}}`,
        encodeURIComponent(String(username))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
  ...
  return {
    ...
    async activateAllDisabledUsers(
      ...
      const localVarOperationServerBasePath =
        operationServerMap['AdminApi.activateAllDisabledUsers']?.[localVarOperationServerIndex]?.url
    ...
    async adminToken(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.adminToken(
        username,
        password,
        grantType,
        scope,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AdminApi.adminToken']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async createAdmin(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AdminApi.createAdmin']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async disableAllActiveUsers(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AdminApi.disableAllActiveUsers']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getAdminUsage(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AdminApi.getAdminUsage']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getCurrentAdmin(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AdminApi.getCurrentAdmin']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async modifyAdmin(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AdminApi.modifyAdmin']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async removeAdmin(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AdminApi.removeAdmin']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async resetAdminUsage(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['AdminApi.resetAdminUsage']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const AdminApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    adminToken(
      ...
      return localVarFp
        .adminToken(username, password, grantType, scope, clientId, clientSecret, options)
...
export class AdminApi extends BaseAPI {
  ...
  public activateAllDisabledUsers(username: string, options?: RawAxiosRequestConfig) {
    return AdminApiFp(this.configuration)
      .activateAllDisabledUsers(username, options)
  ...
  public createAdmin(adminCreate: AdminCreate, options?: RawAxiosRequestConfig) {
    return AdminApiFp(this.configuration)
      .createAdmin(adminCreate, options)
      .then(request => request(this.axios, this.basePath))
      .then(({ data }) => data)
  }
  ...
  public disableAllActiveUsers(username: string, options?: RawAxiosRequestConfig) {
    return AdminApiFp(this.configuration)
      .disableAllActiveUsers(username, options)
      .then(request => request(this.axios, this.basePath))
      .then(({ data }) => data)
  }
  ...
  public getAdminUsage(username: string, options?: RawAxiosRequestConfig) {
    return AdminApiFp(this.configuration)
      .getAdminUsage(username, options)
      .then(request => request(this.axios, this.basePath))
      .then(({ data }) => data)
  }
  ...
  public getAdmins(
    ...
    return AdminApiFp(this.configuration)
      .getAdmins(offset, limit, username, options)
      .then(request => request(this.axios, this.basePath))
      .then(({ data }) => data)
  }
  ...
  public modifyAdmin(username: string, adminModify: AdminModify, options?: RawAxiosRequestConfig) {
    return AdminApiFp(this.configuration)
      .modifyAdmin(username, adminModify, options)
      .then(request => request(this.axios, this.basePath))
      .then(({ data }) => data)
  }
  ...
  public resetAdminUsage(username: string, options?: RawAxiosRequestConfig) {
    return AdminApiFp(this.configuration)
      .resetAdminUsage(username, options)
      .then(request => request(this.axios, this.basePath))
      .then(({ data }) => data)
  }
}
...
export const CoreApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getCoreConfig(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['CoreApi.getCoreConfig']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getCoreStats(
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CoreStats>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getCoreStats(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['CoreApi.getCoreStats']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async modifyCoreConfig(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['CoreApi.modifyCoreConfig']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async restartCore(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['CoreApi.restartCore']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const NodeApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    getNode: async (nodeId: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/node/{node_id}`.replace(`{${'node_id'}}`, encodeURIComponent(String(nodeId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
    ...
    reconnectNode: async (nodeId: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/node/{node_id}/reconnect`.replace(`{${'node_id'}}`, encodeURIComponent(String(nodeId)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
...
export const NodeApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async addNode(
      ...
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<NodeResponse>> {
    ...
    async getNodeSettings(
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<NodeSettings>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getNodeSettings(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['NodeApi.getNodeSettings']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getNodes(
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<NodeResponse>>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getNodes(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['NodeApi.getNodes']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getUsage(
      ...
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<NodesUsageResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getUsage(start, end, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['NodeApi.getUsage']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async modifyNode(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['NodeApi.modifyNode']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async reconnectNode(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['NodeApi.reconnectNode']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async removeNode(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['NodeApi.removeNode']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export class NodeApi extends BaseAPI {
  ...
  public modifyNode(nodeId: number, nodeModify: NodeModify, options?: RawAxiosRequestConfig) {
    return NodeApiFp(this.configuration)
      .modifyNode(nodeId, nodeModify, options)
      .then(request => request(this.axios, this.basePath))
      .then(({ data }) => data)
  }
...
export const SubscriptionApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    userGetUsage: async (
      ...
      const localVarPath = `/sub/{token}/usage`.replace(`{${'token'}}`, encodeURIComponent(String(token)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
    ...
    userSubscription: async (
      ...
      const localVarPath = `/sub/{token}/`.replace(`{${'token'}}`, encodeURIComponent(String(token)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
    ...
    userSubscriptionInfo: async (token: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/sub/{token}/info`.replace(`{${'token'}}`, encodeURIComponent(String(token)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
     ...
     * @throws {RequiredError}
     */
    userSubscriptionWithClientType: async (
      clientType: string,
      token: string,
      userAgent?: string,
      options: RawAxiosRequestConfig = {}
...
export const SubscriptionApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async userGetUsage(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['SubscriptionApi.userGetUsage']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async userSubscription(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['SubscriptionApi.userSubscription']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async userSubscriptionInfo(
      token: string,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SubscriptionUserResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.userSubscriptionInfo(token, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['SubscriptionApi.userSubscriptionInfo']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async userSubscriptionWithClientType(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.userSubscriptionWithClientType(
        clientType,
        token,
        userAgent,
        options
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['SubscriptionApi.userSubscriptionWithClientType']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const SubscriptionApiFactory = function (
  ...
  return {
    ...
    userSubscriptionWithClientType(
      ...
      return localVarFp
        .userSubscriptionWithClientType(clientType, token, userAgent, options)
        .then(request => request(axios, basePath))
    },
  }
}
...
export class SubscriptionApi extends BaseAPI {
  ...
  public userGetUsage(token: string, start?: string, end?: string, options?: RawAxiosRequestConfig) {
    return SubscriptionApiFp(this.configuration)
      .userGetUsage(token, start, end, options)
      .then(request => request(this.axios, this.basePath))
      .then(({ data }) => data)
  }
  ...
  public userSubscription(token: string, userAgent?: string, options?: RawAxiosRequestConfig) {
    return SubscriptionApiFp(this.configuration)
      .userSubscription(token, userAgent, options)
      .then(request => request(this.axios, this.basePath))
      .then(({ data }) => data)
  }
  ...
  public userSubscriptionInfo(token: string, options?: RawAxiosRequestConfig) {
    return SubscriptionApiFp(this.configuration)
      .userSubscriptionInfo(token, options)
      .then(request => request(this.axios, this.basePath))
      .then(({ data }) => data)
  }
   ...
   * @memberof SubscriptionApi
   */
  public userSubscriptionWithClientType(
    clientType: string,
    token: string,
    userAgent?: string,
    options?: RawAxiosRequestConfig
...
export const SystemApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     */
    modifyHosts: async (
      requestBody: { [key: string]: Array<ProxyHost> },
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
...
export const SystemApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getHosts(
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<{ [key: string]: Array<ProxyHost> }>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getHosts(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['SystemApi.getHosts']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getInbounds(
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<{ [key: string]: Array<ProxyInbound> }>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getInbounds(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['SystemApi.getInbounds']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getSystemStats(
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SystemStats>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getSystemStats(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['SystemApi.getSystemStats']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async modifyHosts(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['SystemApi.modifyHosts']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const SystemApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    modifyHosts(
      requestBody: { [key: string]: Array<ProxyHost> },
      options?: RawAxiosRequestConfig
    ): AxiosPromise<{ [key: string]: Array<ProxyHost> }> {
...
export class SystemApi extends BaseAPI {
  ...
  public modifyHosts(requestBody: { [key: string]: Array<ProxyHost> }, options?: RawAxiosRequestConfig) {
    return SystemApiFp(this.configuration)
      .modifyHosts(requestBody, options)
      .then(request => request(this.axios, this.basePath))
      .then(({ data }) => data)
  }
}
...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    activeNextPlan: async (username: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/user/{username}/active-next`.replace(
        `{${'username'}}`,
        encodeURIComponent(String(username))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    deleteExpiredUsers: async (
      ...
      if (expiredAfter !== undefined) {
        localVarQueryParameter['expired_after'] =
          (expiredAfter as any) instanceof Date ? (expiredAfter as any).toISOString() : expiredAfter
      }

      if (expiredBefore !== undefined) {
        localVarQueryParameter['expired_before'] =
          (expiredBefore as any) instanceof Date ? (expiredBefore as any).toISOString() : expiredBefore
      }
    ...
    getUser: async (username: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/user/{username}`.replace(`{${'username'}}`, encodeURIComponent(String(username)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
    ...
    getUserUsage: async (
      ...
      const localVarPath = `/api/user/{username}/usage`.replace(`{${'username'}}`, encodeURIComponent(String(username)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
    ...
    resetUserDataUsage: async (username: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/user/{username}/reset`.replace(`{${'username'}}`, encodeURIComponent(String(username)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
    ...
    revokeUserSubscription: async (username: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/user/{username}/revoke_sub`.replace(
        `{${'username'}}`,
        encodeURIComponent(String(username))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    setOwner: async (
      ...
      const localVarPath = `/api/user/{username}/set-owner`.replace(
        `{${'username'}}`,
        encodeURIComponent(String(username))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const UserApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async activeNextPlan(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['UserApi.activeNextPlan']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async deleteExpiredUsers(
      ...
      expiredBefore?: string | null,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<string | null>>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteExpiredUsers(expiredAfter, expiredBefore, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['UserApi.deleteExpiredUsers']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getExpiredUsers(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['UserApi.getExpiredUsers']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getUserUsage(
      ...
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserUsagesResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getUserUsage(username, start, end, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['UserApi.getUserUsage']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getUsersUsage(
      ...
      admin?: Array<string> | null,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UsersUsagesResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getUsersUsage(start, end, admin, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['UserApi.getUsersUsage']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async modifyUser(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['UserApi.modifyUser']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async removeUser(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['UserApi.removeUser']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async resetUserDataUsage(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['UserApi.resetUserDataUsage']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async resetUsersDataUsage(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['UserApi.resetUsersDataUsage']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async revokeUserSubscription(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['UserApi.revokeUserSubscription']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async setOwner(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['UserApi.setOwner']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const UserApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
    ...
    deleteExpiredUsers(
      ...
      expiredBefore?: string | null,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<Array<string | null>> {
      return localVarFp
        .deleteExpiredUsers(expiredAfter, expiredBefore, options)
        .then(request => request(axios, basePath))
    },
    /**
     * Get users who have expired within the specified date range.  - **expired_after** UTC datetime (optional) - **expired_before** UTC datetime (optional) - At least one of expired_after or expired_before must be provided for filtering - If both are omitted, returns all expired users
    ...
    getUserUsage(
      ...
      options?: RawAxiosRequestConfig
    ): AxiosPromise<UserUsagesResponse> {
    ...
    getUsers(
      ...
      return localVarFp
        .getUsers(offset, limit, username, search, admin, status, sort, options)
        .then(request => request(axios, basePath))
    },
    /**
     * Get all users usage
    ...
    getUsersUsage(
      ...
      admin?: Array<string> | null,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<UsersUsagesResponse> {
...
export class UserApi extends BaseAPI {
  ...
  public activeNextPlan(username: string, options?: RawAxiosRequestConfig) {
    return UserApiFp(this.configuration)
      .activeNextPlan(username, options)
      .then(request => request(this.axios, this.basePath))
      .then(({ data }) => data)
  }
  ...
  public getExpiredUsers(expiredAfter?: string | null, expiredBefore?: string | null, options?: RawAxiosRequestConfig) {
    return UserApiFp(this.configuration)
      .getExpiredUsers(expiredAfter, expiredBefore, options)
      .then(request => request(this.axios, this.basePath))
      .then(({ data }) => data)
  }
  ...
  public getUserUsage(username: string, start?: string, end?: string, options?: RawAxiosRequestConfig) {
    return UserApiFp(this.configuration)
      .getUserUsage(username, start, end, options)
      .then(request => request(this.axios, this.basePath))
      .then(({ data }) => data)
  }
  ...
  public getUsersUsage(start?: string, end?: string, admin?: Array<string> | null, options?: RawAxiosRequestConfig) {
    return UserApiFp(this.configuration)
      .getUsersUsage(start, end, admin, options)
      .then(request => request(this.axios, this.basePath))
      .then(({ data }) => data)
  }
  ...
  public modifyUser(username: string, userModify: UserModify, options?: RawAxiosRequestConfig) {
    return UserApiFp(this.configuration)
      .modifyUser(username, userModify, options)
      .then(request => request(this.axios, this.basePath))
      .then(({ data }) => data)
  }
  ...
  public resetUserDataUsage(username: string, options?: RawAxiosRequestConfig) {
    return UserApiFp(this.configuration)
      .resetUserDataUsage(username, options)
      .then(request => request(this.axios, this.basePath))
      .then(({ data }) => data)
  }
  ...
  public revokeUserSubscription(username: string, options?: RawAxiosRequestConfig) {
    return UserApiFp(this.configuration)
      .revokeUserSubscription(username, options)
      .then(request => request(this.axios, this.basePath))
      .then(({ data }) => data)
  }
  ...
  public setOwner(username: string, adminUsername: string, options?: RawAxiosRequestConfig) {
    return UserApiFp(this.configuration)
      .setOwner(username, adminUsername, options)
      .then(request => request(this.axios, this.basePath))
      .then(({ data }) => data)
  }
}
...
export const UserTemplateApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    getUserTemplateEndpoint: async (templateId: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/user_template/{template_id}`.replace(
        `{${'template_id'}}`,
...
export const UserTemplateApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async addUserTemplate(
      userTemplateCreate: UserTemplateCreate,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserTemplateResponse>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.addUserTemplate(userTemplateCreate, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['UserTemplateApi.addUserTemplate']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getUserTemplateEndpoint(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['UserTemplateApi.getUserTemplateEndpoint']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getUserTemplates(
      ...
      limit?: number,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<UserTemplateResponse>>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getUserTemplates(offset, limit, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['UserTemplateApi.getUserTemplates']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async modifyUserTemplate(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.modifyUserTemplate(
        templateId,
        userTemplateModify,
        options
      )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['UserTemplateApi.modifyUserTemplate']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async removeUserTemplate(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['UserTemplateApi.removeUserTemplate']?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
 ...
 * @export
 */
export const UserTemplateApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
    ...
    addUserTemplate(
      userTemplateCreate: UserTemplateCreate,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<UserTemplateResponse> {
    ...
    getUserTemplates(
      ...
      limit?: number,
      options?: RawAxiosRequestConfig
    ): AxiosPromise<Array<UserTemplateResponse>> {
    ...
    modifyUserTemplate(
      ...
      return localVarFp
        .modifyUserTemplate(templateId, userTemplateModify, options)
        .then(request => request(axios, basePath))
    },
    /**
     * Remove a User Template by its ID
...
export class UserTemplateApi extends BaseAPI {
  ...
  public addUserTemplate(userTemplateCreate: UserTemplateCreate, options?: RawAxiosRequestConfig) {
    return UserTemplateApiFp(this.configuration)
      .addUserTemplate(userTemplateCreate, options)
      .then(request => request(this.axios, this.basePath))
      .then(({ data }) => data)
  }
  ...
  public getUserTemplateEndpoint(templateId: number, options?: RawAxiosRequestConfig) {
    return UserTemplateApiFp(this.configuration)
      .getUserTemplateEndpoint(templateId, options)
      .then(request => request(this.axios, this.basePath))
      .then(({ data }) => data)
  }
  ...
  public getUserTemplates(offset?: number, limit?: number, options?: RawAxiosRequestConfig) {
    return UserTemplateApiFp(this.configuration)
      .getUserTemplates(offset, limit, options)
      .then(request => request(this.axios, this.basePath))
      .then(({ data }) => data)
  }
  ...
  public removeUserTemplate(templateId: number, options?: RawAxiosRequestConfig) {
    return UserTemplateApiFp(this.configuration)
      .removeUserTemplate(templateId, options)
      .then(request => request(this.axios, this.basePath))
      .then(({ data }) => data)
  }
}
